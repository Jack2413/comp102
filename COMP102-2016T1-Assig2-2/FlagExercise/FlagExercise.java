...
public class FlagExercise{
    ...
    public void japanFlag(){
        double Width = UI.askDouble("width for JapanFalg");
        double Height = (Width*2/3);
        double top = (x+Width);
        double left = (y+Height);
        UI.setColor(Color.black);
        UI.setLineWidth(1);
        UI.drawLine(x,y,x,left);
        UI.drawLine(x,y,top,y);
        UI.drawLine(x,left,top,left);
        UI.drawLine(top,y,top,left);
        UI.setColor(Color.red);
        UI.fillOval((x+Width/2)-(Height*2/5/2),y+Height/2-Height*2/5/2,Height*2/5,Height*2/5);/*# YOUR CODE HERE */
