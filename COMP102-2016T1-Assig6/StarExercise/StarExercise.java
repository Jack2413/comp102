...
public class StarExercise{
    ...
    public StarExercise(){
        ...
        UI.addButton("Set Color",this::doChooseColour);
        UI.addButton("Clear",UI::clearPanes);
        UI.addButton("Set center",this::Setcenter);
        UI.addButton("Set tips",this:: Settips);
    ...
    public void doMouse(String action, double x, double y){
        if (action.equals("released")){
            if(setcenter){
                centerX=x;
                centerY=y;
                UI.drawOval(centerX,centerY,2,2);
            }
            else{
    ...
    public void doChooseColour(){
        this.currentColour = JColorChooser.showDialog(null,"choose Color",this.currentColour);
