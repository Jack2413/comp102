...
public class Exercise{
    ...
    public void cartoonCrowd (String filename){
        ...
        try{
            ...
            while(sc.hasNext()){
                ...
                CartoonFigure cartoonfigure = new CartoonFigure(x,y,color);
                figures.add(cartoonfigure);
            }
    ...
    public void plotNumbers(){
        ...
        for (int i=0; i<nums.size();i++){
            double hight=nums.get(i);
            double middle = nums.get((nums.size()-1)/2);
            UI.println(middle);
            if(hight<middle){
