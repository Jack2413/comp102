...
public class LoopsExercise{
    ...
    public void squareNumbers(){
        /*# YOUR CODE HERE */
        UI.print("Enter a sequence of numbers: ending with the word 'done'");
        while(UI.hasNextInt()){
        int num =UI.nextInt();
        int squareNumbers =num*num;
        UI.printf("%d.\n",squareNumbers);
        }
        // Read and throw away the 'done' 
    }
    ...
    public void countWords(){
        double count =0;
        UI.print("enter a sentence,followed by the token '#'");
        while(true){
            String word=UI.next();
        ...
        UI.printf("Sentence has"+ count +"words before'#'.\n");
    }
