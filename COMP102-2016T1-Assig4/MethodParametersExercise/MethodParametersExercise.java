...
public class MethodParametersExercise {
    ...
    public void nameTags(){
        UI.println();
        UI.println("+-------------------------------+");
        UI.println("| The Programming Workshop 2016 |");
        UI.println("|                               |");
     ...
     *  Each nametag has the participant's name and workshop ID number.
     */
    public void nameTagsFixed(){
        this.printNameTag(" John" );
        this.printNameTag(" Jason" );
        this.printNameTag(" Jane" );
        this.printNameTag(" Jie" );
        this.printNameTag(" Julia" );
        UI.println();
    }
     ...
     */
    public void printNameTag(String name){
        UI.println("my name is" + name);
    ...
    public void bottleSongFixed(){
        this.bottleSongVerse(10); // prints verse 10 bottles...
        this.bottleSongVerse(9);  // prints verse 9 bottles..
        this.bottleSongVerse(8);  // prints verse 8 bottles...
    ...
    /** bottleSongVerse should be passed the number of bottles remaining */
    public void bottleSongVerse(int number ){
        UI.println(number + " green bottles, hanging on the wall,");
        UI.println(number + " green bottles, hanging on the wall,");
        UI.println("And if one green bottle, should accidently fall,");
        UI.println("There'd be "+ (number-1) + " green bottles, hanging on the wall,");
        UI.println();
    }
     ...
     *    See http://www.navy.mil/navydata/communications/flags/num0.gif
     */
    public void signalZeroFlagFixed(){
        double flagSize = UI.askDouble("Size of flag:");
        double left = 200;
        double top = 100;
        ...
        //draw crosses
        this.drawCross( (centerX) - crossRad,(centerX) + crossRad,(centerY) - crossRad,(centerY) + crossRad );
        this.drawCross((centerX - offset) - crossRad,(centerX - offset) + crossRad,(centerY - offset) - crossRad,(centerY - offset) + crossRad );
        this.drawCross(left  = (centerX + offset) - crossRad,(centerX + offset) + crossRad,(centerY - offset) - crossRad,(centerY - offset) + crossRad);
        this.drawCross(left  = (centerX - offset) - crossRad,(centerX - offset) + crossRad,(centerY + offset) - crossRad,(centerY + offset) + crossRad);
        this.drawCross(left  = (centerX + offset) - crossRad,(centerX + offset) + crossRad,(centerY + offset) - crossRad,(centerY + offset) + crossRad);
    }

    /** drawCross should be passed the position of the centre of the cross and its size */
    public void drawCross(double left, double right, double top, double bot ){
    ...
    public MethodParametersExercise(){
        ...
        UI.addButton("NameTags", this::nameTagsFixed );
        UI.addButton("BottleSong", this::bottleSongFixed );
        UI.addButton("SignalFlag", this::signalZeroFlagFixed);
